...
from scripts.cnn_rnn.models import RNNBaseline
from scripts.cnn_rnn.utils import (
    ...
    make_tag_rnn, plot_comparisons,
)
from scripts.cnn_rnn.dataset import build_dataloaders

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--config", default="training_configs/rnn.yaml")
    ...
    for i, exp in enumerate(cfg.experiments, 1):
        ...
        model = RNNBaseline(**model_config)
        ...
        save_rich_checkpoint(ckpt_dir, tag, model, model_config, RNNBaseline,
    ...
    print(f"{'=' * 70}")
    plot_comparisons(results, output_dir, "RNN")
